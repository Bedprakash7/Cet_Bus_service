...
public class Driver6Map extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void mapGetOnline(View view){
        ...
        locationListener= new LocationListener() {
            ...
            public void onLocationChanged(Location location) {
                Log.i("Location of Driver 6", location.toString());
                ...
                myFirebase= new Firebase("https://cet-bus-services.firebaseio.com/Driver Bus No/6/Location");
        ...
        //}
        //else{
        if(ContextCompat.checkSelfPermission(Driver6Map.this, android.Manifest.permission.ACCESS_FINE_LOCATION)!= PackageManager.PERMISSION_GRANTED){
    ...
    public void goOfflineClicked(View view){
        //Intent prev =new Intent(Driver6Map.this, Driver6Page.class);
    ...
    public void onBackPressed(){
        if(c==2) {
            ...
            Toast.makeText(Driver6Map.this, "Get offline first", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_driver6_map);
