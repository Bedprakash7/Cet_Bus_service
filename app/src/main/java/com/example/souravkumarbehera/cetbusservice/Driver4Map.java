...
public class Driver4Map extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void goOfflineClicked(View view){
        Intent prev =new Intent(Driver4Map.this, Driver4Page.class);
        myFirebase= new Firebase("https://cet-bus-services.firebaseio.com/Driver Bus No/4/Location");
    ...
    public void onBackPressed(){
        super.onBackPressed();
        myFirebase= new Firebase("https://cet-bus-services.firebaseio.com/Driver Bus No/44/Location");
        Firebase childRef1= myFirebase.child("Latitude");
        childRef1.setValue("");
        Firebase childRef2= myFirebase.child("Longitude");
        childRef2.setValue("");
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if(grantResults.length>0 && grantResults[0]== PackageManager.PERMISSION_GRANTED){
            if(ContextCompat.checkSelfPermission(Driver4Map.this, android.Manifest.permission.ACCESS_FINE_LOCATION)== PackageManager.PERMISSION_GRANTED){
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_driver4_map);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        locationListener= new LocationListener() {
            ...
            public void onLocationChanged(Location location) {
                Log.i("Location of Driver 4", location.toString());
