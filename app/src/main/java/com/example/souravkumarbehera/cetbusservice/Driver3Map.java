...
public class Driver3Map extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void mapGetOnline(View view){
        ...
        locationListener= new LocationListener() {
            ...
            public void onLocationChanged(Location location) {
                Log.i("Location of Driver 3", location.toString());
                ...
                myFirebase= new Firebase("https://cet-bus-services.firebaseio.com/Driver Bus No/3/Location");
        ...
        //}
        //else{
        if(ContextCompat.checkSelfPermission(Driver3Map.this, android.Manifest.permission.ACCESS_FINE_LOCATION)!= PackageManager.PERMISSION_GRANTED){
    ...
    public void goOfflineClicked(View view){
        //Intent prev =new Intent(Driver3Map.this, Driver3Page.class);
    ...
    public void onBackPressed(){
        if(c==2) {
            ...
            Toast.makeText(Driver3Map.this, "Get offline first", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_driver3_map);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        locationListener= new LocationListener() {
            ...
            public void onLocationChanged(Location location) {
                ...
                myFirebase= new Firebase("https://cet-bus-services.firebaseio.com/Driver Bus No/2/Location");
                Firebase childRef1= myFirebase.child("Latitude");
                childRef1.setValue(location.getLatitude());
                Firebase childRef2= myFirebase.child("Longitude");
                childRef2.setValue(location.getLongitude());
