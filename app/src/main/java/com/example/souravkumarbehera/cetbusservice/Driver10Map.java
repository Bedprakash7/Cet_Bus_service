...
public class Driver10Map extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void mapGetOnline(View view){
        ...
        locationListener= new LocationListener() {
            ...
            public void onLocationChanged(Location location) {
                Log.i("Location of Driver 10", location.toString());
                ...
                myFirebase= new Firebase("https://cet-bus-services.firebaseio.com/Driver Bus No/10/Location");
        ...
        //}
        //else{
        if(ContextCompat.checkSelfPermission(Driver10Map.this, android.Manifest.permission.ACCESS_FINE_LOCATION)!= PackageManager.PERMISSION_GRANTED){
    ...
    public void onBackPressed(){
        if(c==2) {
            ...
            Toast.makeText(Driver10Map.this, "Get offline first", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_driver10_map);
