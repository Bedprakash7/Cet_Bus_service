...
public class Driver2Map extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void mapGetOnline(View view){
        ...
        locationListener= new LocationListener() {
            ...
            public void onLocationChanged(Location location) {
                Log.i("Location of Driver 2", location.toString());
        ...
        //}
        //else{
        if(ContextCompat.checkSelfPermission(Driver2Map.this, android.Manifest.permission.ACCESS_FINE_LOCATION)!= PackageManager.PERMISSION_GRANTED){
    ...
    public void goOfflineClicked(View view){
        ...
        c=2;
        //Intent prev =new Intent(Driver2Map.this, Driver2Page.class);
        myFirebase= new Firebase("https://cet-bus-services.firebaseio.com/Driver Bus No/2/Location");
        Firebase childRef1= myFirebase.child("Latitude");
        childRef1.setValue("");
        Firebase childRef2= myFirebase.child("Longitude");
    ...
    public void onBackPressed(){
        if(c==2) {
            ...
            Toast.makeText(Driver2Map.this, "Get offline first", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_driver2_map);
