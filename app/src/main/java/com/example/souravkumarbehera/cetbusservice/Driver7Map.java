...
public class Driver7Map extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void mapGetOnline(View view){
        ...
        locationListener= new LocationListener() {
            ...
            public void onLocationChanged(Location location) {
                Log.i("Location of Driver 7", location.toString());
                ...
                myFirebase= new Firebase("https://cet-bus-services.firebaseio.com/Driver Bus No/7/Location");
        ...
        //}
        //else{
        if(ContextCompat.checkSelfPermission(Driver7Map.this, android.Manifest.permission.ACCESS_FINE_LOCATION)!= PackageManager.PERMISSION_GRANTED){
    ...
    public void goOfflineClicked(View view){
        //Intent prev =new Intent(Driver7Map.this, Driver7Page.class);
    ...
    public void onBackPressed(){
        if(c==2) {
            ...
            Toast.makeText(Driver7Map.this, "Get offline first", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_driver7_map);
