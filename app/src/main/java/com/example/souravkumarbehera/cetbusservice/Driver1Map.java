...
public class Driver1Map extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void mapGetOnline(View view){
        ...
        locationListener= new LocationListener() {
            ...
            public void onLocationChanged(Location location) {
                Log.i("Location of Driver 1", location.toString());
        ...
        //}
        //else{
        if(ContextCompat.checkSelfPermission(Driver1Map.this, android.Manifest.permission.ACCESS_FINE_LOCATION)!= PackageManager.PERMISSION_GRANTED){
    ...
    public void onBackPressed(){
        if(c==2) {
            ...
            Toast.makeText(Driver1Map.this, "Get offline first", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_driver1_map);
